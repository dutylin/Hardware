...
int main(void)
{
  ...
  GPIO_WriteBit(GPIOC, GPIO_Pin_6, TransferStatus1);
  GPIO_WriteBit(GPIOC, GPIO_Pin_7, TransferStatus2);
  ...
  GPIO_WriteBit(GPIOC, GPIO_Pin_8, TransferStatus3);
  GPIO_WriteBit(GPIOC, GPIO_Pin_9, TransferStatus4);
