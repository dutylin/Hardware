...
* Date First Issued  : 08/08/2011
* Description        : Main program body
********************************************************************************/
//¶ÔÓ¦IO¿ÚPD10/PD11/PD12/PD13
...
int main(void)
{
  ...
  EXTI_Init(&EXTI_InitStructure);
   ...
   for(;;)
   {
	GPIOD->ODR = 0xffffc7ff;
	Delay(800);
	GPIOD->ODR = 0xffffcbff;
	Delay(800);
	GPIOD->ODR = 0xffffd3ff;
	Delay(800);
	GPIOD->ODR = 0xffffe3ff;
	Delay(800);
	}   
...
void GPIO_Configuration(void)
{
  ...
  /* Configure Pa7 as input floating (EXTI Line7) */
