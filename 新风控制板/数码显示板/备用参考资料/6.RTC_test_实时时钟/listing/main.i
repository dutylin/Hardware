...
void RCC_Configuration(void)
{
  ...
  RCC_APB2PeriphClockCmd(((u32)0x00004000) | ((u32)0x00000004) | ((u32)0x00000020) |
                         ((u32)0x00000010) , ENABLE);
}
...
u8 USART_Scanf(u32 value)
{
  ...
  while(index < 2)
  {
    ...
    while(USART_GetFlagStatus(((USART_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3800)), ((u16)0x0020)) == RESET)
    {
    }
    tmp[index++] = (USART_ReceiveData(((USART_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3800))));
