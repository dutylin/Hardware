...
int main(void)
{
  ...
  /* Turn off led connected to PD.13 */
  ...
  while(1)
  {
    ...
    /* Turn on led connected to PD.13 */
...
void GPIO_Configuration(void)
{
  ...
  RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOC | RCC_APB2Periph_GPIOB | RCC_APB2Periph_GPIOC |RCC_APB2Periph_GPIOD |RCC_APB2Periph_GPIOE |
                         RCC_APB2Periph_AFIO, ENABLE);

  /* Configure PD.10, PD.11, PD.12 and PD.13 as Output push-pull */
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_10 | GPIO_Pin_11 | GPIO_Pin_12 | GPIO_Pin_13;
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
  GPIO_Init(GPIOD, &GPIO_InitStructure);

  /* Configure PC8 as input floating (EXTI Line8) */
