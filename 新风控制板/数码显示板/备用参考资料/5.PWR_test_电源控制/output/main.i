...
int main(void)
{
  ...
  GPIO_SetBits(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1400)), ((u16)0x0400)); 
  ...
  while(1)
  {
    ...
    RTC_ClearFlag(((u16)0x0001));
    while(RTC_GetFlagStatus(((u16)0x0001)) == RESET);
    ...
    GPIO_ResetBits(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1400)), ((u16)0x0400)); 

     
    PWR_EnterSTOPMode(((u32)0x00000000), ((u8)0x01));
...
void GPIO_Configuration(void)
{
  ...
  RCC_APB2PeriphClockCmd(((u32)0x00000010) | ((u32)0x00000008) | ((u32)0x00000010) |((u32)0x00000020) |((u32)0x00000040) |
...
void EXTI_Configuration(void)
{
  ...
  EXTI_ClearITPendingBit(((u32)0x20000));
  EXTI_InitStructure.EXTI_Line = ((u32)0x20000);
...
void RTC_Configuration(void)
{
  ...
  RTC_ITConfig(((u16)0x0002), ENABLE);
...
void NVIC_Configuration(void)
{
  ...
  NVIC_InitStructure.NVIC_IRQChannel = ((u8)0x29);
...
void SysTick_Configuration(void)
{
  ...
  SysTick_CLKSourceConfig(((u32)0x00000004));

   
  NVIC_SystemHandlerPriorityConfig(((u32)0x02C39A), 3, 0);
