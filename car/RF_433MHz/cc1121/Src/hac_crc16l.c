...
const uint16_t  crc16l_const_table[] = 
{
    0x0000,0x1021,0x2042,0x3063,0x4084,0x50A5,0x60C6,0x70E7,0x8108,0x9129,0xA14A,0xB16B,0xC18C,0xD1AD,0xE1CE,0xF1EF,
};

const uint16_t  crc16l_dis_const_table[] = 
{
...
uint16_t crc16l_update_word(uint16_t crc_in, uint16_t data)
{
