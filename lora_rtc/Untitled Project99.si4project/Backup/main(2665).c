...
void LowPower_ModeConfig()
{
  ...
  GPIO_Init( GPIOA, GPIO_Pin_All, GPIO_Mode_Out_PP_Low_Slow );
   GPIO_ResetBits(GPIOA, PIN_SX127X_RX_CTRL);  
  ...
  GPIO_Init(PORT_SX127X_RX_CTRL, PIN_SX127X_RX_CTRL, GPIO_Mode_Out_PP_Low_Slow);
  ...
  GPIO_SetBits(PORT_SX127X_DIO3, PIN_SX127X_DIO3);  
  GPIO_Init(PORT_SX127X_DIO4, PIN_SX127X_DIO4, GPIO_Mode_In_FL_No_IT);
  GPIO_SetBits(PORT_SX127X_DIO4, PIN_SX127X_DIO4);
  GPIO_Init(PORT_SX127X_DIO5, PIN_SX127X_DIO5, GPIO_Mode_In_FL_No_IT);
  GPIO_SetBits(PORT_SX127X_DIO5, PIN_SX127X_DIO5);  
  GPIO_Init(PORT_SX127X_CSN, PIN_SX127X_CSN, GPIO_Mode_Out_OD_Low_Slow);
  GPIO_SetBits(PORT_SX127X_CSN, PIN_SX127X_CSN);
  GPIO_ResetBits(PORT_SX127X_CSN, PIN_SX127X_CSN);
