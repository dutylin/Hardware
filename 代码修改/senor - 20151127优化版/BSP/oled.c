...
/**************************************************************
函数：void OLED_WrDat(unsigned char dat)
功能：写入一个字节数据
**************************************************************/
...
/**************************************************************
函数：void OLED_Refresh_Gram(void)
功能：更新显存到OLED
**************************************************************/
...
/**************************************************************
函数：void OLED_DLY_ms(unsigned int ms)
功能：延时函数
**************************************************************/
...
/**************************************************************
函数：void OLED_Fill(u8 x1,u8 y1,u8 x2,u8 y2,u8 dot)
功能：写满屏数据,x1,y1,x2,y2 填充区域的对角坐标,dot:0,清空;1,填充
**************************************************************/
...
功能：画点 x:0~127 y:0~63 t:1 填充 0,清空
**************************************************************/
...
/**************************************************************
函数：void OLED_ShowChar(u8 x,u8 y,u8 chr,u8 size,u8 mode)
功能：在指定位置显示一个字符,包括部分字符 x:0~127 y:0~63 mode:0,反白显示;1,正常显示 size:选择字体 16/12
      mode:1 填充 0,清?
**************************************************************/
...
/**************************************************************
函数：void OLED_ShowString(u8 x,u8 y,const u8 *p)
功能：显示字符串 x,y:起点坐标  *p:字符串起始地址 用16字体
**************************************************************/
...
/**************************************************************
函数：void OLED_ShowNum(u8 x,u8 y,u32 num,u8 len,u8 size)
功能：显示2个数字 x,y :起点坐标 len :数字的位数 size:字体大小 mode:模式	0,填充模式;1,叠加模式 num:数值(0~4294967295);
**************************************************************/
