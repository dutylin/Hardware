...
#define     OLED_RST_L                      HAL_GPIO_WritePin(GPIOB, GPIO_PIN_12,GPIO_PIN_RESET);
#define     OLED_RST_H                       HAL_GPIO_WritePin(GPIOB, GPIO_PIN_12,GPIO_PIN_SET);


#define	    OLED_DC_L                     HAL_GPIO_WritePin(GPIOC, GPIO_PIN_6,GPIO_PIN_RESET) ;
#define     OLED_DC_H                       HAL_GPIO_WritePin(GPIOC, GPIO_PIN_6,GPIO_PIN_SET) ;
...
#define NotSelect_OLED   HAL_GPIO_WritePin(GPIOB GPIO_PIN_2,GPIO_PIN_SET);
...
void OLED_WB(uint8_t data){
	...
	uint8_t pRxData;
HAL_SPI_TransmitReceive(&hspi2, &data, &pRxData, 1, 10);	
}
/*******************一个字节数据写入***********************/
