...
*  ************************************************************************ */
#define CMT2300A_SetGpio1In()            GPIO_Init(INTERRUPT_PORT,INT1, GPIO_Mode_In_PU_No_IT);
#define CMT2300A_SetGpio2In()           GPIO_Init(INTERRUPT_PORT,INT2, GPIO_Mode_In_PU_No_IT);
#define CMT2300A_SetGpio3In()           SET_GPIO_IN(CMT_GPIO3_GPIO)
#define CMT2300A_ReadGpio1()            GPIO_ReadInputDataBit(INTERRUPT_PORT, INT1)
#define CMT2300A_ReadGpio2()            GPIO_ReadInputDataBit(INTERRUPT_PORT, INT2)
